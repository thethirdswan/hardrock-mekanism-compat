...
public class ItemTags extends ItemTagsProvider {
	...
	public static final TagKey<Item> NICKEL_DUST = TagKey.create(Registries.ITEM,
			ResourceLocation.fromNamespaceAndPath("forge", "dusts/nickel"));
	public static final TagKey<Item> SILVER_DUST = TagKey.create(Registries.ITEM,
			ResourceLocation.fromNamespaceAndPath("forge", "dusts/silver"));
	public static final TagKey<Item> BISMUTH_DUST = TagKey.create(Registries.ITEM,
			ResourceLocation.fromNamespaceAndPath("forge", "dusts/bismuth"));
	public static final TagKey<Item> ALUMINUM_DUST = TagKey.create(Registries.ITEM,
			ResourceLocation.fromNamespaceAndPath("forge", "dusts/aluminium"));
	public static final TagKey<Item> CHROMIUM_DUST = TagKey.create(Registries.ITEM,
			ResourceLocation.fromNamespaceAndPath("forge", "dusts/chromium"));
	public static final TagKey<Item> ZINC_DUST = TagKey.create(Registries.ITEM,
	...
	public static final TagKey<Item> DIRTY_DUSTS = TagKey.create(Registries.ITEM,
			ResourceLocation.fromNamespaceAndPath("mekanism", "dirty_dusts"));
	public static final TagKey<Item> CLUMPS = TagKey.create(Registries.ITEM,
	...
	public static final TagKey<Item> CRYSTALS = TagKey.create(Registries.ITEM,
			ResourceLocation.fromNamespaceAndPath("mekanism", "crystals"));
	public static final TagKey<Item> HOURGLASS_DUSTS = TagKey.create(Registries.ITEM,
